...
const MeetingTypeList = () => {
  ...
  const createMeeting = async () => {
    ...
    try {
      ...
      if (!call) throw new Error("failed to create call" || "Call not created");
      ...
      {!callDetails ? (
        ...
        >
          <div className="flex flex-col gap-2.5">
            <label className="text-base text-sky-2 leading-[22px]">
              Add a description
            </label>
            <Textarea
              className="border-none focus-visible:ring-0 focus-visible:ring-offset-0 bg-dark-3 "
              onChange={(e) => {
