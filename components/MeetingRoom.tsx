...
const MeetingRoom = () => {
  ...
  return (
    <section className="relative h-screen w-full p-4 overflow-hidden text-white">
      <div className="flex relative size-full justify-center items-center">
      ...
      <div className="fixed items-center justify-center w-full bottom-0 flex gap-5  flex-wrap">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="border-toast-1 bg-dark-1 text-white">
            {["grid", "Speaker-Left", "Speaker-Right"].map((item, index) => (
              <div key={index}>
                ...
                <DropdownMenuSeparator className="border-toast-1" />
              </div>
            ))}
          </DropdownMenuContent>
        </DropdownMenu>
